...
## Six live tickets each

JJ-26, JJ-27 and JJ-28 are landed, so they are owned but not workload. That
leaves eighteen live items, split three ways along verticals rather than layers
— a layered split makes every feature cross all three owners.

| Owner | Vertical | Live tickets | Specs |
| --- | --- | --- | --- |
| Jaya Joshi | Content grounding and deck fidelity | AT-59, ES-39, ES-40, JJ-29, JJ-30, JJ-31 | [`docs/gamma/`](../gamma/) |
| Mayank Somwani | User surface and filed history | AT-61, MS-27, MS-28, MS-29, MS-30, MS-31 | this folder |
| Blenard Tahiraj | Pipeline stages and release | AT-60, BT-28, BT-29, BT-30, BT-31, BT-32 | this folder |
